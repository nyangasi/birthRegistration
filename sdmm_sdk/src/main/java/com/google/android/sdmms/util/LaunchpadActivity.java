...
public class LaunchpadActivity extends Activity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "CREATE lauchpad "
    ...
    protected void onStart() {
        super.onStart();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "START lauchpad "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    ...
    protected void onResume() {
        ...
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "RESUME lauchpad "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    ...
    protected void onPause() {
        super.onPause();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "PAUSE lauchpad "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    ...
    protected void onStop() {
        super.onStop();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "STOP lauchpad "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "DESTROY lauchpad "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
