...
public class TestedScreen extends Activity
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "CREATE tested "
        ...
        if (LaunchpadActivity.FORWARD_RESULT.equals(getIntent().getAction())) {
            ...
            if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "Finishing tested "
                    + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
            finish();
    ...
    protected void onResume() {
        super.onResume();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "RESUME tested "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    ...
    protected void onStop() {
        super.onStop();
        if (ActivityTestsBase.DEBUG_LIFECYCLE) Log.v("test", "STOP tested "
                + Integer.toHexString(System.identityHashCode(this)) + ": " + getIntent());
    }
