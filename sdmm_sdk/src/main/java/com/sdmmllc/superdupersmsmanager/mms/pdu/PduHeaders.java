...
public class PduHeaders {
        ...
        switch (field) {
            ...
            case SENDER_VISIBILITY:
                if ((VALUE_YES != value) && (VALUE_NO != value)) {
                    // Invalid value.
                    throw new InvalidHeaderValueException("Invalid Octet value! Value:" + value + " field:"+ field);
                }
                break;
            case READ_STATUS:
            ...
            default:
                ...
                throw new RuntimeException("Invalid header field! Value:" + value + " field:"+ field);
        }
    ...
    protected void setTextString(byte[] value, int field) {
        ...
        switch (field) {
            ...
            default:
                ...
                throw new RuntimeException("Invalid header field! Value: " + value.toString() + " field:" + field);
        }
        mHeaderMap.put(field, value);
    }
    ...
    protected void setEncodedStringValue(EncodedStringValue value, int field) {
        ...
        switch (field) {
            ...
            default:
                ...
                throw new RuntimeException("Invalid header field" + value.getString() + " field:" + field);
        }
    ...
    protected void setEncodedStringValues(EncodedStringValue[] value, int field) {
        ...
        switch (field) {
            ...
            default:
                // This header value should not be Encoded-String-Value.
                throw new RuntimeException("Invalid header field" + value + " field:"+ field);
        }
