...
public abstract class Plot<SeriesType extends Series, FormatterType extends Formatter, RendererType extends SeriesRenderer>
    ...
    /**
     * Convenience constructor - wraps {@link #Plot(Context, String, com.androidplot.Plot.RenderMode)}.
     ...
     * </code>
     *
     * See {@link com.androidplot.xy.XYPlot#XYPlot(Context, AttributeSet)}
     * for an example.
     * @param context
     * @param attrs
     */
     ...
     * </code>
     *
     * See {@link com.androidplot.xy.XYPlot#XYPlot(Context, AttributeSet, int)}
     * for an example.
     * @param context
     * @param attrs
     * @param defStyle
